    ...
    ko.bindingHandlers.multiselect = {
      ...
      init: function(
        ...
        if (allBindings.has("enable")) {
          ...
          if (window.ko.isObservable(enable)) {
            window.ko
              .computed({
                read: function() {
                  setEnabled(enable());
  ...
  Multiselect.prototype = {
    defaults: {
      ...
      buttonText: function(options, select) {
        if (
          ...
          (select.prop("disabled") ||
            (select.children().length === 0 && this.disableIfEmpty))
        ) {
      ...
      templates: {
        ...
        filter:
          '<li class="multiselect-item multiselect-filter"><div class="input-group mx-2 mb-2"><div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-search"></i></span></div><input class="form-control multiselect-search" type="text" /></div></li>',
        filterClearBtn:
          '<div class="input-group-append"><button class="btn btn-primary multiselect-clear-filter" type="button"><i class="fa fa-times-circle"></i></button></div>',
        li:
          '<li class="dropdown-item"><div class="form-check" tabindex="0"><label></label></div></li>',
        divider:
          '<li class="dropdown-item multiselect-item dropdown-divider"></li>',
        liGroup:
          '<li class="dropdown-item multiselect-item multiselect-group"><label></label></li>',
        resetButton:
          '<li class="multiselect-reset text-center"><div class="input-group"><a class="btn btn-primary btn-block"></a></div></li>',
      },
    },
    ...
    createOptionValue: function(element) {
      ...
      var optionComponentId =
        "bootstrap-multiselect-option-" + value + "-" + randomNum;
    ...
    createOptgroup: function(group) {
      ...
      var $li = $(
        '<li class="multiselect-item multiselect-group"><a href="javascript:void(0);"><label class="mb-0"><b></b></label></a></li>'
      );
      ...
      if (this.options.enableCollapsibleOptGroups && this.options.multiple) {
        $("a", $li).append(
          '<span class="caret-container ml-3"><i class="fas fa-angle-down"></i></span>'
        );
      }
    ...
    selectAll: function(justVisible, triggerOnSelectAll) {
      ...
      var visibleLis = $(
        "li:not(.divider):not(.disabled):not(.multiselect-group):not(.multiselect-filter-hidden):not(.multiselect-collapsible-hidden)",
        this.$ul
      ).filter(":visible");
